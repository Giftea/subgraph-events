...
export class Web3Events__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class Web3Events extends ethereum.SmartContract {
  static bind(address: Address): Web3Events {
    return new Web3Events("Web3Events", address);
  }

  idToEvent(param0: Bytes): Web3Events__idToEventResult {
    ...
    return new Web3Events__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<Web3Events__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Web3Events__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
